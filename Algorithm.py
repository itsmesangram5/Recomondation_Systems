...
def most_similar_users(target_person, no_of_users):
    ...
    scores = [(person_corelation(target_person, other_person), other_person)
              for other_person in dataset if other_person != target_person]
...
def recommendation_phase(person):
    ...
    recommendataions_list = [(recommend_item, score)
